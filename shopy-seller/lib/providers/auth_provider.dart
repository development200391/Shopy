...
class AuthNotifier extends Notifier<AuthState> {
  ...
  /// Dipanggil setelah buka toko sukses — token baru sudah bawa claim role/store_id
  /// terbaru (lihat SellerApiService.openStore), jadi sesi lokal cukup ditimpa.
  Future<void> refreshSessionFrom(AuthResponse response) => _persistSession(response);
