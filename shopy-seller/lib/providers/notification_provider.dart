...
/// toko `Active` (lihat `post_auth_router.dart`), stream-nya didengarkan di
...
/// Jumlah notifikasi belum dibaca — dipakai buat badge ikon lonceng di Beranda.
...
class NotificationHistoryNotifier extends Notifier<NotificationHistoryState> {
  ...
  NotificationHistoryState build() {
    ...
    // uninitialized provider" begitu halaman Notifikasi dibuka.
    //
    // Catatan: `_load()` di `store_settings_provider.dart` TIDAK kena masalah ini
