          ...
          Positioned(
            ...
            child: SafeArea(
              ...
              child: InAppNotificationBanner(
                title: message.notification?.title ?? 'Shopy',
                body: message.notification?.body ?? '',
                icon: message.data['type'] == 'promo' ? Icons.local_offer : Icons.shopping_bag,
                iconColor: message.data['type'] == 'promo' ? AppColors.secondary : AppColors.primary,
                onDismiss: _dismiss,
                onTap: () {
                  _dismiss();
                  Navigator.of(
